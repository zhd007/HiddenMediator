...
mediation_simulation <- function(true_hidden) {
  ...
  }, error=function(e){    return(list("temp.record" = temp.record, "a_coefs" = a_coefs, "c_coefs" = c_coefs))  })
...
record <- data.frame("freq" = rep(-9, set),  "true_freq" = rep(-9, set), 
                     ...
                     "b.low1b" = rep(-9, set), "b.high1b" = rep(-9, set),
                     "b.low2" = rep(-9, set), "b.high2" = rep(-9, set),
                     "b.low2b" = rep(-9, set), "b.high2b" = rep(-9, set),
...
write.csv(data.frame(matrix(unlist(a_coefs), nrow=length(a_coefs), byrow=T)), row.names = FALSE,
          "/home/dingzh/t2d_mediation/continuous/base_case/a_coefs.snp500.csv")
write.csv(data.frame(matrix(unlist(c_coefs), nrow=length(c_coefs), byrow=T)), row.names = FALSE,
          "/home/dingzh/t2d_mediation/continuous/base_case/c_coefs.snp500.csv")
...
write.csv(record, row.names = FALSE,
          "/home/dingzh/t2d_mediation/continuous/base_case/record.snp500.csv")
